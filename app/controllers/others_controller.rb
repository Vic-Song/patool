class OthersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @other.save
        format.html { redirect_to home_admin_path, notice: 'Other was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @other.update(other_params)
        format.html { redirect_to home_admin_path, notice: 'Other was successfully updated.' }
  ...
  def destroy
    @other.destroy
    respond_to do |format|
      format.html { redirect_to home_admin_path, notice: 'Other was successfully destroyed.' }
  ...
  private
    ...
    def other_params
      params.require(:other).permit(:title, :question_id)
    end
end
